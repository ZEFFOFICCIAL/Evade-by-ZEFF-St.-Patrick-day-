...
for i, v in ipairs(inputs) do
    ...
    lbl.Parent = Frame
    lbl.Text = v[3]
    lbl.Size = UDim2.new(0, 170, 0, 15)
    lbl.Position = UDim2.new(0, 18, 0, (i-1)*55 + 10)
    ApplyStyle(lbl, true)
    
    inp.Parent = Frame
    inp.Size = UDim2.new(0, 170, 0, 30)
    inp.Position = UDim2.new(0, 15, 0, (i-1)*55 + 25)
    ApplyStyle(inp)
...
UIS.InputBegan:Connect(function(i, g)
    ...
    if i.KeyCode == Enum.KeyCode.B then 
        ...
        if bright_enabled then 
            Lighting.Brightness = 10000 -- ПІДСИЛЕНО
